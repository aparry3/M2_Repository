 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Aaron Parry");
		  toPrint += p1.toString("aparry3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Antonia Deliyianni");
		  toPrint += p2.toString("adeliyianni3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Lauren Liou");
		  toPrint += p3.toString("lliou3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Ethan Vargas");
                  toPrint += p4.toString("evargas30");
